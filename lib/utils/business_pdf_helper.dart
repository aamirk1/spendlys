...
class BusinessPdfHelper {
  static Future<void> generateAndPrintPdf({
    ...
    final String dueDateStr = isInvoice 
        ? (docData['due_date'] != null && docData['due_date'].toString().isNotEmpty && docData['due_date'] != 'null' ? DateFormat('dd MMM yyyy').format(DateTime.parse(docData['due_date'])) : 'N/A')
        : (docData['expiry_date'] != null && docData['expiry_date'].toString().isNotEmpty && docData['expiry_date'] != 'null' ? DateFormat('dd MMM yyyy').format(DateTime.parse(docData['expiry_date'])) : 'N/A');
              ...
              children: [
                pw.Column(
                  ...
                  children: [
                    ...
                    if (businessProfile['gst_number'] != null && businessProfile['gst_number'].toString().isNotEmpty)
                ...
                pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text('No: $docNumber', style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                    pw.Text('Date: $dateStr'),
                    if (dueDateStr != 'N/A') pw.Text('${isInvoice ? "Due" : "Expiry"} Date: $dueDateStr'),
                  ],
                ),
              ],
            ),
              ...
              children: [
                ...
                pw.TableRow(
                  ...
                  children: [
                    ...
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                      child: pw.Text('Unit Price', textAlign: pw.TextAlign.right, style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                    ),
                    pw.Padding(
                      padding: const pw.EdgeInsets.all(8),
                ...
                ...processedItems.map((item) {
                  return pw.TableRow(
                    children: [
                      ...
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text(item['quantity']?.toString() ?? '1', textAlign: pw.TextAlign.center),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text('Rs ${item['unit_price'] ?? '0'}', textAlign: pw.TextAlign.right),
                      ),
                      pw.Padding(
                        padding: const pw.EdgeInsets.all(8),
                        child: pw.Text('Rs ${item['amount'] ?? '0'}', textAlign: pw.TextAlign.right),
                      ),
                    ],
                  );
                }),
              ...
              children: [
                pw.Padding(
                  ...
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.end,
                    children: [
                      _buildSummaryRow('Subtotal:', 'Rs ${docData['subtotal'] ?? '0.00'}'),
                      _buildSummaryRow(
                      ...
                      _buildSummaryRow(
                        'Grand Total:', 
                        'Rs ${docData['total'] ?? '0.00'}', 
                        isTotal: true
                      ),
                      if (isInvoice) ...[
                        _buildSummaryRow('Paid Amount:', 'Rs ${docData['paid_amount'] ?? '0.00'}'),
                        _buildSummaryRow(
                          'Balance Due:', 
                        ...
                        _buildSummaryRow('Advance Paid:', 'Rs ${docData['advance_amount'] ?? '0.00'}'),
                        _buildSummaryRow(
                          'Remaining:', 
            ...
            if (businessProfile['payment_details'] != null && 
              ...
              pw.Container(
                ...
                child: pw.Column(
                  crossAxisAlignment: pw.CrossAxisAlignment.start,
                  children: [
                    pw.Text('PAYMENT DETAILS', style: pw.TextStyle(fontWeight: pw.FontWeight.bold, fontSize: 12)),
                    ...
                    pw.Row(
                      ...
                      children: [
                        pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.start,
                          children: [
                            pw.Text('Bank: ${businessProfile['payment_details'][0]['bank_name'] ?? 'N/A'}'),
                            pw.Text('A/C No: ${businessProfile['payment_details'][0]['account_number'] ?? 'N/A'}'),
                            pw.Text('IFSC: ${businessProfile['payment_details'][0]['ifsc'] ?? 'N/A'}'),
                          ],
                        ),
                        pw.Column(
                          crossAxisAlignment: pw.CrossAxisAlignment.end,
                          children: [
                            pw.Text('UPI ID: ${businessProfile['payment_details'][0]['upi_id'] ?? 'N/A'}'),
                          ],
                        ),
                      ],
                    ),
  ...
  static pw.Widget _buildSummaryRow(String label, String value, {bool isTotal = false, PdfColor color = PdfColors.black}) {
    return pw.Padding(
        ...
        children: [
          ...
          pw.SizedBox(
            ...
            child: pw.Text(
              ...
              style: pw.TextStyle(fontSize: isTotal ? 14 : 12, fontWeight: isTotal ? pw.FontWeight.bold : pw.FontWeight.normal, color: color)
            ),
          ),
        ],
      ),
