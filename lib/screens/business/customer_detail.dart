        ...
        child: Column(
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: const Color(0xFF5F33E1).withOpacity(0.06),
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    if (due > 0)
                      Text("₹${due.toStringAsFixed(0)} Due", style: TextStyle(color: Colors.redAccent.withOpacity(0.8), fontSize: 9, fontWeight: FontWeight.w500)),
                  ],
                ),
                const SizedBox(width: 8),
