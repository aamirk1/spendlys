...
class EditInvoiceController extends GetxController {
  ...
  void initData(Map<String, dynamic> inv) {
    ...
    taxPercent.value = ((inv['tax'] ?? 0.0) / (inv['subtotal'] ?? 1.0) * 100).toDouble();
                            ...
                            _buildCard(children: [
                              ...
                              DropdownButtonFormField<String>(
                                ...
                                items: controller.customers.map((c) {
                                  return DropdownMenuItem<String>(
                                    value: c['id'].toString(),
                                    child: Text(c['name'] ?? 'Unknown Customer'),
                                  );
                                }).toList(),
                              ...
                              TextFormField(
                                ...
                                onTap: () async {
                                  ...
                                  if (d != null) {
                                    controller.dueDateController.text = d.toString().split(" ")[0];
                                  }
                                },
                              ...
                              Obx(() => DropdownButtonFormField<String>(
                                    ...
                                    decoration: _inputDeco("Payment Mode", Icons.payment_rounded),
                                    style: const TextStyle(fontSize: 14, color: Colors.black87, fontWeight: FontWeight.w500),
