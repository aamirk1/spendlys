...
import 'package:spendly/app/common_widgets/business_dialogs.dart';
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              if (active == 'Invoices')
                Flexible(
                  child: _buildInvoiceFilterPills(
                      controller, primaryColor, accentColor),
                )
              else if (active == 'Quotations')
                Flexible(
                  child: _buildQuotationFilterPills(
                      controller, primaryColor, accentColor),
                )
              else
                Container(
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            const SizedBox(height: 2),
            Text(inv['customer']?['name'] ?? 'Unknown Customer',
                style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
                    color: Colors.grey.shade700)),
    ...
    return Card(
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            const SizedBox(height: 2),
            Text(q['customer']?['name'] ?? 'Unknown Customer',
                style: TextStyle(
                    fontSize: 12,
                    fontWeight: FontWeight.w600,
                    color: Colors.grey.shade700)),
