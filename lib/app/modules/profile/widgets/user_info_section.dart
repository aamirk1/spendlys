              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  colors: [
                    ...
                    Theme.of(context).primaryColor.withBlue(220).withValues(alpha: 0.95),
                  ],
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: isPremium
            ...
            : null,
        color: isPremium ? null : Colors.white.withValues(alpha: 0.2),
      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            if (onTap != null) ...[
              const SizedBox(width: 4),
              Icon(Icons.copy_rounded, size: 10, color: Colors.white.withValues(alpha: 0.6)),
            ]
          ],
        ),
      ),
