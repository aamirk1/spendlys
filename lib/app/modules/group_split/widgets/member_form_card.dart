    ...
    Widget buildAvatar() {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          color: isCreator ? AppColors.primary.withValues(alpha: 0.1) : Colors.grey.shade100,
          shape: BoxShape.circle,
          border: Border.all(
            color: isCreator ? AppColors.primary.withValues(alpha: 0.3) : Colors.grey.shade200,
            width: 1.5,
          ),
        ),
        child: Center(
