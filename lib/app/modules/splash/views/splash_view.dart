...
import 'package:spendly/app/modules/splash/controllers/splash_controller.dart';
...
class _DailyBachatSplashScreenState extends State<DailyBachatSplashScreen>
  ...
  void initState() {
    ...
    // Progress bar fills over splash duration (~0.6 s)
...
class _SplashParticleState extends State<_SplashParticle>
  ...
  void initState() {
    ...
    _color = colors[widget.index % colors.length].withValues(alpha: 0.28);
