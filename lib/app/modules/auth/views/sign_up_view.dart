...
import 'package:spendly/app/modules/auth/controllers/sign_up_controller.dart';
...
class _StrengthBadge extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AnimatedContainer(
      ...
      decoration: BoxDecoration(
        color: isValid
            ? AppColors.green.withValues(alpha: isDark ? 0.15 : 0.08)
            : (isDark
                ? Colors.white.withValues(alpha: 0.02)
        ...
        border: Border.all(
          color: isValid
              ? AppColors.green.withValues(alpha: isDark ? 0.4 : 0.3)
              : (isDark
                  ? Colors.white.withValues(alpha: 0.05)
                  : Colors.black.withValues(alpha: 0.05)),
          width: 1,
