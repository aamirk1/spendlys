              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: BackdropFilter(
                    ...
                    child: Container(
                      color: Colors.black.withValues(alpha: 0.7 * animVal),
                    ),
                  ),
                ),
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: item.color.withValues(alpha: 0.4 * animVal),
                                  blurRadius: 12,
                                  spreadRadius: 2,
                                ),
                              ],
                      ...
                      child: GestureDetector(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            boxShadow: [
                              BoxShadow(
                                color: Colors.black.withValues(alpha: 0.3 * animVal),
                                blurRadius: 10,
...
class RadialMenuPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final outerPaint = Paint()
      ..color = Colors.purple.withValues(alpha: 0.15 * animationValue)
    ...
    final innerPaint = Paint()
      ..color = Colors.purple.withValues(alpha: 0.2 * animationValue)
      ..style = PaintingStyle.stroke
      ..strokeWidth = 1.0;
