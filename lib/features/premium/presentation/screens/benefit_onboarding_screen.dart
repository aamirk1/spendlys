        ...
        GestureDetector(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                  color: const Color(0xFFFF9F00).withValues(alpha: 0.25),
                  blurRadius: 10,
          ...
          child: Stack(
            children: [
              Positioned(
                ...
                child: _Orb(
                  size: 240,
                  color: const Color(0xFFFF9F00).withValues(alpha: 0.08),
                ),
              ),
              Positioned(
                bottom: -80 + (t * -20),
                ...
                child: _Orb(
                  size: 260,
                  color: const Color(0xFF00B2E7).withValues(alpha: 0.07),
                ),
              ),
              Positioned(
                ...
                child: _Orb(
                  size: 150,
                  color: const Color(0xFFE064F7).withValues(alpha: 0.04),
                ),
              ),
            ],
          ),
